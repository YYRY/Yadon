...
<html lang="ja">
	...
	<body>
		...
		<header>
			...
			<ul>
				<li><a href="" title="お問い合わせ"><img src="img/icon/お問い合わせ.png" width="50" height="50" alt="お問い合わせ"></a></li>
				<li><a href="" title="Q &amp; A"><img src="img/icon/Q&A.png" width="50" height="50" alt="Q &amp; A"></a></li>
				<li><a href="" title="サイトマップ"><img src="img/icon/sitemap.png" width="50" height="50" alt="サイトマップ"></a></li>
				<li><a href="" title="ログイン"><img src="img/icon/ログイン.png" width="50" height="50" alt="ログイン"></a></li>
			</ul>
		</header>
