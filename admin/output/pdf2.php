...
$pdf -> cell(50 , 10 , "性別" , '1' , 0 , "L" , 1);
$pdf -> cell(50 , 10 , "生年月日" , '1' , 1 , "L" , 1);

while( $row = mysql_fetch_array( $res ) ){

	$pdf -> setFillColor(255 , 255 , 255);
	$pdf -> setTextColor(0 , 0 , 0);
	$pdf -> cell(50 , 10 , $row[0]."性" , 'TBLR' , 0);
...
$pdf -> cell(100 , 10 , "男性：".$count1."件" , '1' , 1 , "L" , 1);
$pdf -> cell(100 , 10 , "女性：".$count2."件" , '1' , 1 , "L" , 1);
$pdf -> cell(100 , 10 , "全：".$all_count."件" , '1' , 1 , "L" , 1);
